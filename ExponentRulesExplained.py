...
if sect == "Finding Products or Quotients of Powers With Like Bases":
	...
	st.write("Just as we discussed finding quotients of a power in the previous section, here, we'll discuss the inverse of that; finding quotients of powers with the same bases. Doing this is quite simple. All you need to do, is just take the exponent of the second power, and subtract it from the exponent of the first power. Whether it's positive, negative or 0 (see \"Fixed Rules\"), you just simply subtract, and whatever the resulting power is would be your answer. For example, if you take $4^2/4^5$, then you'd just have to subtract the 5 from the 2, which would give you -3. This would leave you $4^{(-3)}$")
